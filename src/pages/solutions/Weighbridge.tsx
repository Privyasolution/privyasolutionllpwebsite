...
const Weighbridge: React.FC = () => (
  <ServicePage
    ...
    description="Privya Solution's Weighbridge Management System automates the complete vehicle weighing process — from entry to dispatch — with RFID vehicle identification, automated weight capture, anti-cheat mechanisms, and enterprise system integration."
    benefits={[
      ...
      'Real-time integration with enterprise dispatch and billing systems',
    ...
    technologies={[
      ...
      'RS232 / TCP-IP Interface', 'Enterprise System Integration', 'SAP MM/SD Integration',
      'Tally Integration', 'SMS Gateway', 'Email Alerts', 'Thermal Printing',
      'Cloud Dashboard', 'On-Premise', 'PostgreSQL', 'Mobile App',
    ]}
    workflow={[
      ...
      { step: 5, title: 'Document Generation', description: 'Weighment challan, delivery note, and invoice auto-generated and printed. Enterprise system updated in real-time.' },
