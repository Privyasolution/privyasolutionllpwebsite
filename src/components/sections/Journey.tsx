...
const steps = [
  ...
  },
  {
    ...
    icon: GitBranch,
    title: 'Integration',
    description: 'Seamless integration with existing enterprise systems, hardware devices, legacy platforms, and third-party services.',
    details: ['API development', 'Hardware integration', 'Enterprise connectivity', 'Data migration'],
